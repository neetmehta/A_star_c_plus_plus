...
public:
	...
	std::vector<Point> get_neighbors(Point point, std::vector<std::vector<bool>>& visited, std::vector<std::vector<bool>>& visited_neighbors, std::map<std::vector<int>, std::vector<int>>& mp);
	void astar();
